...
class SortingTrianglesUtilsTest {
    ...
    class ParseDoubleOrNullTests{
        ...
        void should_ReturnDouble_When_Input_Is_CorrectNumber(String valueOfString){
            ...
            //when
            boolean expected  = number.equals(SortingTrianglesUtils.parseDoubleOrNull(valueOfString));
            //then
            assertTrue(expected);
        }
        ...
        void should_ReturnNull_When_Input_Is_NotAValidNumber(String valueOfString){
            ...
            assertNull(SortingTrianglesUtils.parseDoubleOrNull(valueOfString));
        }
